...
public class UIElement {
	...
	public void fitOnScreen(){
		...
		if(this.getFinalLoc().getX() + width/2 > 800) { //TODO CHANGE THIS IF WINDOW DIMENSIONS CHANGE
		...
		if(this.getFinalLoc().getY() + height/2 > 800) { //TODO CHANGE THIS IF WINDOW DIMENSIONS CHANGE
